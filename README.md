...
``` 
gcc -o main.exe src/*.c -I src/include -L src/lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -Wall -Wextra -Wno-#warnings -pedantic -Wshadow -std=c99 -fstack-protector -Wno-unused-parameter -O1 -s
```
